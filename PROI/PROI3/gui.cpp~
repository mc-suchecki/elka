...
#include <fstream>		//obsluga strumieni plikowych
...
void ZapiszOkno();		//zapisanie danych okna do pliku
...
int main()
{
  ...
  while(1)
  {
    ...
    cout << " (w)czytaj okno z pliku, (z)apisz okno do pliku, (k)oniec" << endl;
    ...
    switch(wybor)
    {
      ...
      case 'w': break;
      case 'z': ZapiszOkno(); break;		//zapisanie okna do pliku
