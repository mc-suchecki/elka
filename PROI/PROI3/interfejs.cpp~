...
//metoda klasy Widget wypisująca dane klasy
void Widget::Write(ostream &os) const
{
  os << name << " " << pos_x << " " << pos_y << " " << endl;
}//void Widget::Show() const
...
//metoda klasy Button wypisująca dane klasy
void Button::Write(ostream &os) const
{
  os << "Button: " << name << " " << pos_x << " " << pos_y;
  os << " " << text << " " << pressed << endl;
}//void Button::Show() const
...
//metoda klasy CheckBox wypisująca dane klasy
void CheckBox::Write(ostream &os) const
{
  os << "CheckBox: " << name << " " << pos_x << " ";
  os << pos_y << " " << text << " " << checked << endl;
}//CheckBox::Show() const
...
//metoda klasy ProgressBar wypisująca dane klasy
void ProgressBar::Write(ostream &os) const
{
  os << "ProgressBar: " << name << " " << pos_x << " ";
  os << pos_y << " " << size_x << " " << size_y << " ";
  os << progress << endl;
}//void ProgressBar::Show()
...
//metoda klasy TextBox wypisująca dane klasy
void TextBox::Write(ostream &os) const
{
  os << "TextBox: " << name << " " << pos_x << " ";
  os << pos_y << " " << size_x << " " << size_y << " ";
  os << text << endl;
}//void TextBox::Show()
...
//funkcja zapisujaca dane okna do pliku
void Window::Write(ostream & os)
{
  os << name << " " << title << " ";
  os << pos_x << " " << pos_y << " " << size_x << " ";
  os << size_y << endl;
  ...
  for(; it != widgets.end(); ++it)
  {
    (*(*it)).Write(os);			//wypisanie widzetu
  }//for

}//Window::Write(ostream & os)
